...
The effects of population size do have a significant effect though, in general higher population sizes increase the rate at which the algorithm improves. This makes intuitive sense; the more individuals, the faster the possibility space can be explored. However, higher population sizes also result in more computational cost, so for all trials in @tasks, a size of 1000 was used; this choice was mostly arbitrary, but it appeared to be a size that wasn't too big nor too small.
